                                            ...
                                            <form id="form" name="learn-press-login" method="post">
                                                ...
                                                <ul class="form-fields">
                                                    <li class="form-field">
                                                        ...
                                                        <input id="username" type="text" name="password" placeholder="Enter Username" autocomplete="current-password" />
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="password">Old Password&nbsp;<span class="required">*</span></label>
                                                        <input id="oldpassword" type="password" name="password" placeholder="Enter Old Password" autocomplete="current-password" />
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="password">New Password&nbsp;<span class="required">*</span></label>
                                                        <input id="newpassword" type="password" name="password" placeholder="Enter New Password" autocomplete="current-password" />
                                                    </li>
                                                </ul>
                                                <p>
                                                    <input type="hidden" name="learn-press-login-nonce" value="dbea8043a7">
                                                    <button id="changepassword" type="submit">Submit</button>
                                                </p>
                                            </form>
                                        </div>
                                    </div>
 ...
 -->
    ...
    <script>
        $("#changepassword").click(function(e) {
            ...
            $.ajax({
                url: "/ssip/assets/codes/change_password_query.php",
                type: 'POST',
