                                            ...
                                            <form id="form" name="learn-press-login" method="post">
                                                ...
                                                <ul class="form-fields">
                                                    <li class="form-field">
                                                        ...
                                                        <input id="newpassword" type="password" name="newpassword" placeholder="Enter password" autocomplete="current-password" />
                                                    </li>
                                                </ul>
                                                <p>
 ...
 -->
    ...
    <script>
        $("#updatepassword").click(function(e) {
            ...
            {
                $.ajax({
                url: "/ssip/assets/codes/new_password_query.php",
                type: 'POST',
