...
<head>
    ...
    <title>Update School &rarr; SLMS</title>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Update School</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="learnpress">
                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-register-wrap col-md-6 col-md-push-3">
                                        ...
                                        <div class="learn-press-form-register learn-press-form">
                                            ...
                                            <h3 style="text-align: center;">Update School</h3>

                                            <form name="learn-press-register" method="post" action="<?= urlOf('assets/codes/update_school_code.php') ?>" enctype="multipart/form-data">
                                                <ul class="form-fields">
                                                    <li class="form-field">
                                                        <label for="reg_name">School Name&nbsp;<span class="required">*</span></label>
                                                        <input id="schoolname" name="s_name" type="text" placeholder="Enter School name : " autocomplete="email" value="<?= $result['s_name'] ?>" required>
                                                        <input name="id" type="hidden" value="<?= $result['id'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_email">Change Password&nbsp;<span class="required">*</span></label>
                                                        <input id="edate" name="password" type="password" placeholder="Change Password : " autocomplete="email" value="<?= $result['password'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_email">School Establish Date&nbsp;<span class="required">*</span></label>
                                                        <input id="edate" name="date" type="date" placeholder="Enter University Email : " autocomplete="email" value="<?= $result['date'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Number&nbsp;<span>*</span></label>
                                                        <input id="number" name="number" type="number" placeholder="Enter Number : " autocomplete="number" value="<?= $result['number'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Alternate Number&nbsp;<span>*</span></label>
                                                        <input id="anumber" name="a_number" type="number" placeholder="Enter Alternate Number : " autocomplete="number" value="<?= $result['a_number'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Website &nbsp;<span>*</span></label>
                                                        <input id="anumber" name="website" type="text" placeholder="Enter Website URL : " autocomplete="number" value="<?= $result['website'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Email&nbsp;<span>*</span></label>
                                                        <input id="email" name="email" type="email" placeholder="Enter Email : " autocomplete="number" value="<?= $result['email'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Address&nbsp;<span>*</span></label>
                                                        <input id="address" name="address" type="text" placeholder="Enter Address : " autocomplete="number" value="<?= $result['address'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your State&nbsp;<span>*</span></label>
                                                        <input list="state" name="state" required value="<?= $result['state'] ?>">
                                                        <datalist id="state">
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <input list="district" name="district" required value="<?= $result['district'] ?>">
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <input list="board" name="board" required value="<?= $result['board'] ?>">
                                                        <datalist id="board">
                                                            <option value="Gujarat Board">Gujarat Board</option>
                                                            <option value="Maharastra Board">Maharastra Board</option>
                                                        </datalist>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Preview of last Image&nbsp;<span>*</span></label>
                                                        <img src="<?= $result['s_image'] ?>" alt="" height="100px" width="100x">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Upload Updated School Image&nbsp;<span>*</span></label>
                                                        <input id="s_image" name="image" type="file" placeholder="Upload Student Image : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Description&nbsp;<span>*</span></label>
                                                        <input id="description" name="description" type="text" placeholder="Description " autocomplete="number" value="<?= $result['description'] ?>" required>
                                                    </li>
                                                </ul>
                                                <p>
                                                    ...
                                                    <button type="submit" id="addschool">Update School</button>
                                                </p>
