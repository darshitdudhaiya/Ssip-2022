...
$select_school = "SELECT * FROM schools";
$query_school = $connection->query($select_school);
$result_school = $query_school->fetchAll(PDO::FETCH_ASSOC);

$select_college = "SELECT * FROM colleges";
$query_college = $connection->query($select_college);
$result_college = $query_college->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <title>Add Student &rarr; SLMS</title>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Edit Student</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="page-main-content" class="page-main-content">
                            ...
                            <article id="post-90" class="post-90 page type-page status-publish hentry pmpro-has-access post-no-thumbnail">
                                ...
                                <div class="learnpress">
                                        ...
                                        <div class="learn-press-form-login learn-press-form">
                                            ...
                                            <form name="learn-press-login" method="post" action="#">
                                                ...
                                                <ul class="form-fields">
                                                    <li class="form-field">
                                                        <label for="username">SLMS No or Username&nbsp;<span class="required">*</span></label>
                                                        <input type="text" name="username" id="username" placeholder="SLMS No or Username :" autocomplete="username" />
                                                    </li>
                                                    <li class="form-field">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-6 lost-your-password-wrap">
                                                        <p>
                                                            <a href="../my-account/lost-password/index.html" class="lost-your-password">Lost your password?</a>
                                                        </p>
                                                    </div>
                                                </div>
                                                <p>
                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-register-wrap col-md-6 col-md-push-3">
                                        ...
                                        <div class="learn-press-form-register learn-press-form">
                                            ...
                                            <form name="learn-press-register" method="post" action="<?= urlOf('assets/codes/update_student_code.php') ?>" enctype="multipart/form-data">
                                                <ul class="form-fields">

                                                    <li class="form-field">
                                                        <label for="reg_username">School Name&nbsp;<span>*</span></label>
                                                        <input list="class" name="sc_name" required value="">
                                                        <datalist id="class">
                                                            <?php foreach ($result_school as $ans_school) { ?>
                                                                <option value="<?= $ans_school['s_name'] ?>"></option>
                                                            <?php } ?>
                                                            <?php foreach ($result_college as $ans_college) { ?>
                                                                <option value="<?= $ans_college['c_name'] ?>"></option>
                                                            <?php } ?>
                                                        </datalist>
                                                    </li>
                                                    <li class="form-field">
                                                        <!-- <label for="slms_no">SLMS No&nbsp;<span class="required">*</span></label> -->
                                                        <input name="slms_no" type="hidden" placeholder="SLMS No : " value="<?= $result['slms_no'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <!-- <label for="slms_password">SLMS Password&nbsp;<span class="required">*</span></label> -->
                                                        <input name="slms_password" type="hidden" placeholder="SLMS Password : " value="<?= $result['slms_password'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="student_name">Student Name&nbsp;<span class="required">*</span></label>
                                                        <input id="student_name" name="stud_name" type="text" placeholder="Surname Name Fathers-name : " autocomplete="email" value="<?= $result['stud_name'] ?>">
                                                        <input name="id" type="hidden" value="<?= $result['id'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="fathers_name">Fathers Name&nbsp;<span class="required">*</span></label>
                                                        <input id="fathers_name" name="f_name" type="text" placeholder="Surname Name Fathers-name : " autocomplete="email" value="<?= $result['f_name'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="mothers_name">Mothers Name&nbsp;<span class="required">*</span></label>
                                                        <input id="mothers_name" name="m_name" type="text" placeholder="Surname Name Husbands-name : " autocomplete="email" value="<?= $result['m_name'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="fathers_occ">Fathers Occupation&nbsp;<span class="required">*</span></label>
                                                        <input id="fathers_occ" name="f_occupation" type="text" placeholder="Enter Fathers Occupation : " autocomplete="email" value="<?= $result['f_occupation'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="mothers_occ">Mothers Occupation&nbsp;<span class="required">*</span></label>
                                                        <input id="mothers_occ" name="m_occupation" type="text" placeholder="Enter Mothers Occupation : " autocomplete="email" value="<?= $result['m_occupation'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your Gender&nbsp;<span>*</span></label>
                                                        <select name="gender">
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your Caste&nbsp;<span>*</span></label>
                                                        <select name="caste">
                                                    ...
                                                    <li class="form-field">
                                                    <label>Select Your Blood Group&nbsp;<span>*</span></label>
                                                    <select name="blood">
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <input id="email" name="email" type="email" placeholder="Enter your Email : " autocomplete="email" value="<?= $result['email'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="dob">Date of Birth&nbsp;<span class="required">*</span></label>
                                                        <input id="dob" name="dob" type="date" placeholder="Enter University Email : " autocomplete="email" value="<?= $result['dob'] ?>">
                                                    </li>
                                                    <!-- <li class="form-field">
                                                        <label for="b_groop">Blood Group&nbsp;<span class="required">*</span></label>
                                                        <input id="b_groop" name="blood" type="text" placeholder="Enter Date of Birth :  " autocomplete="number" value="<?= $result['blood'] ?>">
                                                    </li> -->
                                                    <li class="form-field">
                                                        <label for="number">Number&nbsp;<span>*</span></label>
                                                        <input id="number" name="number" type="number" placeholder="Enter Number : " autocomplete="number" value="<?= $result['number'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="a_namber">Alternate Number&nbsp;<span>*</span></label>
                                                        <input id="a_number" name="a_number" type="number" placeholder="Enter Alternate Number : " autocomplete="number" value="<?= $result['a_number'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="aadhar">Adharcard Number&nbsp;<span>*</span></label>
                                                        <input id="aadhar" name="adhar" type="text" placeholder="Enter Adharcard Number : " autocomplete="number" value="<?= $result['adhar'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your Course&nbsp;<span>*</span></label>
                                                        <input list="course" name="class" required>
                                                        <datalist id="course">
                                                            ...
                                                            <option value="BACHELOR OF ARCHITECTURE"></option>
                                                            <option value="BACHELOR OF ENGINEERING"></option>
                                                            <option value="BACHELOR OF ENGINEERING (PART TIME)"></option>
                                                            <option value="BACHELOR OF HOTEL MANAGEMENT AND CATERING TECHNOLOGY"></option>
                                                            <option value="BACHELOR OF INTERIOR DESIGN"></option>
                                                            <option value="BACHELOR OF PHARMACY"></option>
                                                            <option value="BACHELOR OF PHARMACY (PRACTICE)"></option>
                                                            <option value="BACHELOR OF PLANNING"></option>
                                                            <option value="BACHELOR OF VOCATION"></option>
                                                            <option value="BACHLOR OF BUSINESS ADMINISTRATION"></option>
                                                            <option value="DIPLOMA IN ARCHITECTURE"></option>
                                                            <option value="DIPLOMA IN ENGINEERING"></option>
                                                            <option value="DIPLOMA IN PHARMACY"></option>
                                                            <option value="DIPLOMA IN VOCATION"></option>
                                                            <option value="DOCTOR OF PHILOSOPHY"></option>
                                                            <option value="MASTER OF ARCHITECTURE"></option>
                                                            <option value="MASTER OF ARTS IN HINDU STUDIES"></option>
                                                            <option value="MASTER OF BUSINESS ADMINISTRATION"></option>
                                                            <option value="MASTER OF BUSINESS ADMINISTRATION (INTEGRATED / APPLIED MANAGEMENT)"></option>
                                                            <option value="MASTER OF BUSINESS ADMINISTRATION (PART TIME)"></option>
                                                            <option value="MASTER OF COMPUTER APPLICATIONS"></option>
                                                            <option value="MASTER OF COMPUTER APPLICATIONS (INTEGRATED)"></option>
                                                            <option value="MASTER OF ENGINEERING"></option>
                                                            <option value="MASTER OF PHARMACY"></option>
                                                            <option value="MASTER OF PHILOSOPHY"></option>
                                                            <option value="MASTER OF SCIENCE (INDUSTRIAL BIOTECHNOLOGY)"></option>
                                                            <option value="MASTER OF SCIENCE (INTEGRATED)"></option>
                                                            <option value="PHARM.D."></option>
                                                            <option value="PHARM.D. (POST BACCALAUREATE)"></option>
                                                            <option value="POST DIPLOMA DEGREE COURSE"></option>
                                                            <option value="POST GRADUATE DIPLOMA IN BIOINFORMATICS"></option>
                                                            <option value="POST GRADUATE DIPLOMA IN DATA SCIENCE"></option>
                                                            <option value="POST GRADUATE DIPLOMA IN DIGITAL MARKETING"></option>
                                                            <option value="POST GRADUATE DIPLOMA IN HOSPITAL MANAGEMENT"></option>
                                                            <option value="POST GRADUATE DIPLOMA IN IPR"></option>
                                                            <option value="Doctor of Medicine"></option>
                                                            <option value="Master of Commerce"></option>
                                                            <option value="Master of Commerce Integrated with Finance & International Business"></option>
                                                            <option value="Master of Arts"></option>
                                                            <option value="Master of Laws"></option>
                                                            <option value="Master of Education"></option>
                                                            <option value="Master of Science - Information Technology"></option>
                                                            <option value="Master of Journalism Studies"></option>
                                                            <option value="Master of Development Communication"></option>
                                                            <option value="Master of Physical Education"></option>
                                                            <option value="Master of Labour Welfare"></option>
                                                            <option value="Master of Surgery"></option>
                                                            <option value="Master of Library & Information Sciences"></option>
                                                            <option value="Master of Nursing"></option>
                                                            <option value="Master of Chirugai"></option>
                                                            <option value="Master of Dental Surgery"></option>
                                                            <option value="Master of Pysiotherapy"></option>
                                                            <option value="Bachelor of Arts"></option>
                                                            <option value="Bachelor of Commerce"></option>
                                                            <option value="Bachelor of Science"></option>
                                                            <option value="Bachelor of Laws"></option>
                                                            <option value="Bachelor of Education"></option>
                                                            <option value="Bachelor of Physical Education"></option>
                                                            <option value="Bachelor of Computer Application"></option>
                                                            <option value="Bachelor of Business Administration"></option>
                                                            <option value="Bachelor of Drama"></option>
                                                            <option value="Bachelor of Library & Information Sciences"></option>
                                                            <option value="Bachelor of Physiotherapy"></option>
                                                            <option value="Bachelor of Medicine & Bachelor of Surgery"></option>
                                                            <option value="Bachelor of Science Nursing"></option>
                                                            <option value="Bachelor of Science Audio & Speech Therapy"></option>
                                                            <option value="Bachelor of Dental Surgery"></option>
                                                            <option value="Bachelor of Communication, Journalism & Public Relations"></option>
                                                            <option value="Bachelor of Science Fire"></option>
                                                            <option value="Bachelor of Architect"></option>
                                                            <option value="Certificate Course in English Improvement"></option>
                                                            <option value="Certificate Course in Stenography & Secretarial Practice"></option>
                                                            <option value="Certificate Course in Office Management"></option>
                                                            <option value="Certificate Course in Banking Management"></option>
                                                            <option value="Certificate Course in French"></option>
                                                            <option value="Certificate Course in German"></option>
                                                            <option value="Certificate Course in Data Entry"></option>
                                                            <option value="Certificate Course in Urdu"></option>
                                                            <option value="Certificate Course in Aphabhramsha"></option>
                                                            <option value="Post Graduate Certificate Course in Prakrita"></option>
                                                        </datalist>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your Division / Semester&nbsp;<span>*</span></label>
                                                        <input list="ddss" name="ds" required>
                                                        <datalist id="ddss">
                                                            ...
                                                            <option value="Sem-9"></option>
                                                            <option value="Sem-10"></option>
                                                            <option value="Sem-11"></option>
                                                            <option value="Sem-12"></option>
                                                        </datalist>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_marks">Marks of Previous Class&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_marks" name="marks" type="number" autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_email">Date of Admission&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="ad_date" type="date" autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="remarks">Remarks&nbsp;<span>*</span></label>
                                                        <input id="remarks" name="remarks" type="text" placeholder="Remarks : " autocomplete="number" value="<?= $result['remarks'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="state">Select Your State&nbsp;<span>*</span></label>
                                                        <input type="text" id="state" name="state" value="<?= $result['state'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="district">Select Your District / Village&nbsp;<span>*</span></label>
                                                        <input type="text" id="district" name="district" value="<?= $result['district'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="board">Select Your Board&nbsp;<span>*</span></label>
                                                        <input type="text" id="board" name="board" value="<?= $result['board'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Preview of Last Image&nbsp;<span>*</span></label>
                                                        <img src="<?= $result['image'] ?>" alt="" height="100px" width="100px">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Upload Updated Image&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="image" type="file" placeholder="Upload Student Image : " autocomplete="number" value="" required>
                                                    </li>
                                                </ul>
                                                <p>
                                                    <input type="hidden" id="learn-press-register-nonce" name="learn-press-register-nonce" value="2ef144c6c1" /><input type="hidden" name="_wp_http_referer" value="/main/profile/" />
                                                    <button type="submit" id="update">Update Student</button>
                                                </p>
