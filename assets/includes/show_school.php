...
// $panel = $_SESSION['user_type'] = 'School Panel';
// echo $panel;
// echo $_SESSION["user_type"]
if ($_SESSION['user_type'] == 'School Panel') {
	...
	$select = "SELECT * FROM schools  WHERE s_name = '$username'";
...
<head>
	...
	<title>School Profile &rarr; SLMS</title>
								...
								<div class="row">
									<div class="col-md-12">
										<ul class="insight_core_breadcrumb">
											...
											<li class="level-2 sub tail current"><span><?= $result['s_name'] ?></span></li>
										</ul>
									</div>
								</div>
							</div>
											...
											<div class="row">
												<div class="col-md-5">
													<div class="lp-profile-cover">
														<div class="lp-profile-avatar"><img alt='User Avatar' src='<?= $result['s_image'] ?>' srcset='<?= $result['s_images'] ?>' class='avatar avatar-470 photo' style="height: 620px; width: 413px;" loading='lazy' /></div>
													</div>
												</div>

												<div class="col-md-6 col-md-push-1">
													<div class="lp-profile-info">
														<h3 class="profile-name"><?= $result['s_name'] ?></h3>
														<div class="author-career"> / <?= $result['district'] ?> / INDEX-No : <?= $result['index_no'] ?> </div>

														<h5 class="profile-contact-info" style="text-decoration: underline;">School Information :</h5>
														<div class="profile-author-meta">
															...
															<div class="share-list">
																<div class="inner" style="display:flex;">
																	<form action="./add_school_student.php"  style="margin:20px;">
																		<a class="hint--bounce hint--top hint--primary facebook" target="_self" aria-label="Add Student" href="../includes/add_school_student.php">
																			<button type="submit" value="<?= $result["id"] ?>" name="add_stud" style="background-color:orange; border-color:orange; border-radius:50%; padding:0px 20px 20px;">
																				<center><i class="fab fa fa-plus" id="addstudent"></i></center>
																			</button>
																		</a>
																		<?php	
																	...
																	<form action="./all_student.php"  style="margin:20px;">
																		<a class="hint--bounce hint--top hint--primary twitter" target="_self" aria-label="View Student" href="../includes/all_student.php">
																			<button type="submit" value="<?= $result["s_name"] ?>" name="view" style="background-color:grey; border-color:grey; border-radius:50%; padding:0px 18px 0px;"><i class="fab fa fa-eye"></i></button>
																		</a>
																	</form>
																	<form action="./update_school.php"  style="margin:20px;">
																		<a class="hint--bounce hint--top hint--primary linkedin" target="_self" aria-label="Update School" href="../includes/update_school.php">
																			<button type="submit" value="<?= $result["id"] ?>" name="update_id" style="border-radius:50%; padding:0px 20px 20px;"><i class="fab fa fa-arrow-up"></i></button>
																		</a>
																	</form>
																</div>
															</div>
