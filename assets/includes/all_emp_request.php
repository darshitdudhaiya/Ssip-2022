...
// $name = $_POST['view'];
$select = "SELECT * FROM emp_req WHERE status = 'pending' ";
                        ...
                        <div class="row row-xs-center">
                            <div class="col-md-12">
                                ...
                                <div class="page-title-bar-heading">
                                    <h1 class="heading"> Requested User </h1>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Requested User</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div id="page-main-content" class="page-main-content">
                            ...
                            <table class="table" id="myTable" style="margin-left: -60px;">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    foreach ($result as $data) { ?>
                                        <tr>
                                            <td><?= $data['emp_no'] ?></a></td>
                                            <td><?= $data['emp_name'] ?></a></td>
                                            <td><?= $data['number'] ?></a></td>
                                            <td><?= $data['a_number'] ?></a></td>
                                            <td><?= $data['email'] ?></a></td>
                                            <td><?= $data['address'] ?></a></td>
                                            <td><?= $data['state'] ?></a></td>
                                            <td><?= $data['district'] ?></a></td>
                                            <td><a href="<?= $data['emp_adhar'] ?>" target="_blank">Adhar-Card</a></td>
                                            <td><a href="<?= $data['emp_pan'] ?>" target="_blank">Pan-Card</a></td>
                                            <td><a href="<?= $data['emp_election'] ?>" target="_blank">Election-Card</a></td>
                                            <td><a href="../codes/add_emp_accept.php?id=<?= $data['id'] ?>" style="color: green; font-size:25px">✓</a></td>
                                            <td><a href="../codes/add_emp_reject.php?id=<?= $data['id'] ?>">❌</a></td>
                                            <td><a href="../includes/emp_remark.php?id=<?= $data['id'] ?>" style="font-size:18px">✏️</a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
