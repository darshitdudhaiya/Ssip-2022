				...
				<ul id="mobile-menu-primary" class="menu__container">
					...
					<li id="menu-item-20" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-20 level-1">
						<?php if (isset($_SESSION["user_type"])) { ?>
							<?php if ($_SESSION['user_type'] == 'Government Panel' || $_SESSION["user_type"] == 'Edu-Department Panel') { ?>
								<a href="#">
									<div class="menu-item-wrap"><span class="menu-item-title">Requests</span><span class="toggle-sub-menu"> </span></div>
								</a>
					...
					<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1817 level-1">
						<a href="#">
							<div class="menu-item-wrap"><span class="menu-item-title">Reports</span></div>
						</a>
					...
					<?php if (isset($_SESSION['user_type'])) { ?>
						<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1817 level-1">
							...
							<a href="<?= urlOf('assets/codes/logout.php') ?>">
								<div class="menu-item-wrap"><span class="menu-item-title">Logout</span></div>
							</a>
					...
					<?php if (!isset($_SESSION['user_type'])) { ?>
						<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1817 level-1">
							<a href="<?= urlOf('assets/includes/login.php') ?>">
								<div class="menu-item-wrap"><span class="menu-item-title"><i class="far fa-user-circle"></i> &nbsp;login</span></div>
							</a>
						</li>
					<?php } ?>
														...
														<?php if ($_SESSION['user_type'] == 'Government Panel' || $_SESSION["user_type"] == 'Edu-Department Panel') { ?>
															...
															<a href="<?= urlOf('assets/includes/login.php') ?>">
																...
																<?php if ($_SESSION["user_type"] == 'Government Panel' || $_SESSION["user_type"] == 'Edu-Department Panel') { ?>
																	<li id="menu-item-423" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-423">
																		<a href="<?= urlOf('assets/includes/all_student_request.php') ?>">
																			<div class="menu-item-wrap"><span class="menu-item-title">Student Requests &nbsp;&nbsp;&nbsp;<span style="background-color:red;color:white; border-radius: 50%; padding:3px 9px; font-size: 15pt;"><?= $result_all['StudentCount'] ?></span></span></div>
																		</a>
																	</li>
																<?php } ?>
																<?php if ($_SESSION["user_type"] == 'Government Panel') { ?>
