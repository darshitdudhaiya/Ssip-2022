...
$select = "SELECT count(*) as Count FROM students  WHERE slms_no = $slms_no && slms_password = '$slms_password'";
$query = $connection->query($select);
$result = $query->fetch(PDO::FETCH_ASSOC);
if ($result['Count'] == 1) {
	$select = "SELECT * FROM students  WHERE slms_no = $slms_no && slms_password = '$slms_password'";
	$query = $connection->query($select);
	$result = $query->fetch();
} else {
	header('Location: ./student_login.php');
}
$select_course = "SELECT * FROM life_cycle  WHERE slms_no = $slms_no ORDER BY ad_date DESC";
$query_course = $connection->query($select_course);
$result_course = $query_course->fetchAll(PDO::FETCH_ASSOC);

// $select_course = 'SELECT nursery FROM selc';
// $query_course = $connection->query($select_course);
// $result_course = $query_course->fetch();
...
<!-- Mirrored from maxcoach.thememove.com/main/profile/maggiestrickland/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Sep 2022 05:22:01 GMT -->
<!-- Added by HTTrack -->
...
<head>
	...
	<title>Student Profile &rarr; SLMS</title>
	...
	<link rel='stylesheet' id='maxcoach-child-demo-style-css' href='../css/sstyle.css' media='all' />
	...
	<script id='lp-global-js-extra'>
		...
		var lpGlobalSettings = {
			"url": "https:\/\/maxcoach.thememove.com\/main\/profile\/maggiestrickland\/",
	...
	<meta name="msapplication-TileImage" content="../images/indian-government-logo.png">
	<noscript>
		<style>
	...
	<style id="kirki-inline-styles">
		...
		.bac {
            background-image: url(../images/home-personal-finance-section-shape-bottom-right.png);
            background-size: cover;
            background-position: center;
        }

		/* .bac{
            background-image: url(../images/tricolor-brush.jpeg);
            background-size: cover;
        } */
	</style>
</head>
								...
								<div class="header-wrap">
									...
									<div class="branding">
										<div class="branding__logo">
											<a href="../../index.html" rel="home">
												<img src="../images/dark-logo.png" alt="MaxCoach" class="dark-logo">
											</a>
										</div>
									</div>
									...
									<div id="page-navigation" class="navigation page-navigation">
										<nav id="menu" class="menu menu--primary">
											<ul id="menu-primary" class="menu__container sm sm-simple">
												<li id="menu-item-14" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-14 level-1 has-mega-menu"><a href="https://maxcoach.thememove.com/">
												...
												<li id="menu-item-20" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-20 level-1"><a href="#">
													...
													<ul class="sub-menu children simple-menu">
														<li id="menu-item-1852" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1852"><a href="../../start-here/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Start Here</span></div>
															</a></li>
														<li id="menu-item-1851" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1851"><a href="../../success-story/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Success Story</span></div>
															</a></li>
														<li id="menu-item-426" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-426"><a href="../../about-me/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">About me</span></div>
															</a></li>
														<li id="menu-item-425" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-425"><a href="../../about-us-01/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">About us 01</span></div>
															</a></li>
														<li id="menu-item-424" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-424"><a href="../../about-us-02/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">About us 02</span></div>
															</a></li>
														<li id="menu-item-423" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-423"><a href="../../about-us-03/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">About us 03</span></div>
															</a></li>
														<li id="menu-item-422" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-422"><a href="../../contact-me/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Contact me</span></div>
															</a></li>
														<li id="menu-item-421" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-421"><a href="../../contact-us/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Contact us</span></div>
															</a></li>
														<li id="menu-item-1668" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1668"><a href="../../purchase-guide/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Purchase Guide</span></div>
															</a></li>
														<li id="menu-item-1660" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-1660"><a href="../../privacy-policy/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Privacy Policy</span></div>
															</a></li>
														<li id="menu-item-1659" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1659"><a href="../../terms-of-service/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Terms of Service</span></div>
															</a></li>
													</ul>
												</li>
												<li id="menu-item-97" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-97 level-1"><a href="../../courses/index.html">
														<div class="menu-item-wrap"><span class="menu-item-title">Courses</span><span class="toggle-sub-menu"> </span></div>
													</a>
													<ul class="sub-menu children simple-menu">
														<li id="menu-item-228" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-228"><a href="../../courses-grid-01/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Courses Grid 01</span></div>
															</a></li>
														<li id="menu-item-227" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-227"><a href="../../courses-grid-02/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Courses Grid 02</span></div>
															</a></li>
														<li id="menu-item-226" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-226"><a href="../../courses-grid-03/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Courses Grid 03</span></div>
															</a></li>
														<li id="menu-item-1681" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1681"><a href="../../membership-account/membership-levels/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Membership Levels</span></div>
															</a></li>
														<li id="menu-item-98" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-98"><a href="../../become-a-teacher/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Become a Teacher</span></div>
															</a></li>
														<li id="menu-item-1539" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-1539"><a href="index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Profile</span></div>
															</a></li>
														<li id="menu-item-100" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-100"><a href="../../course-checkout/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Checkout</span></div>
															</a></li>
														<li id="menu-item-124" class="menu-item menu-item-type-post_type menu-item-object-lp_course menu-item-has-children menu-item-124"><a href="../../course/programming-for-everyone-python/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Single Layout</span><span class="toggle-sub-menu"> </span></div>
															</a>
															<ul class="sub-menu children simple-menu">
																<li id="menu-item-3347" class="menu-item menu-item-type-post_type menu-item-object-lp_course menu-item-3347"><a href="../../course/customer-centric-info-tech-strategies/index.html">
																		<div class="menu-item-wrap"><span class="menu-item-title">Free Course</span></div>
																	</a></li>
																<li id="menu-item-125" class="menu-item menu-item-type-post_type menu-item-object-lp_course menu-item-125"><a href="../../course/programming-for-everyone-python/index.html">
																		<div class="menu-item-wrap"><span class="menu-item-title">Sticky Features Bar</span></div>
																	</a></li>
																<li id="menu-item-123" class="menu-item menu-item-type-post_type menu-item-object-lp_course menu-item-123"><a href="../../course/master-jquery-in-a-short-time/index.html">
																		<div class="menu-item-wrap"><span class="menu-item-title">Standard Sidebar</span></div>
																	</a></li>
																<li id="menu-item-128" class="menu-item menu-item-type-post_type menu-item-object-lp_course menu-item-128"><a href="../../course/introduction-to-javascript-for-beginners/index.html">
																		<div class="menu-item-wrap"><span class="menu-item-title">No Sidebar</span></div>
																	</a></li>
															</ul>
														</li>
													</ul>
												</li>
												<li id="menu-item-3338" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3338 level-1"><a href="#">
														<div class="menu-item-wrap"><span class="menu-item-title">Features</span><span class="toggle-sub-menu"> </span></div>
													</a>
													<ul class="sub-menu children simple-menu">
														<li id="menu-item-1818" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1818"><a href="../../events/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Events</span></div>
															</a></li>
														<li id="menu-item-3339" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3339"><a href="../../zoom-meetings/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Zoom Meetings</span></div>
															</a></li>
													</ul>
												</li>
												<li id="menu-item-1652" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1652 level-1"><a href="../../blog/index.html">
														<div class="menu-item-wrap"><span class="menu-item-title">Blog</span><span class="toggle-sub-menu"> </span></div>
													</a>
													<ul class="sub-menu children simple-menu">
														<li id="menu-item-860" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-860"><a href="../../blog-grid/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Blog Grid</span></div>
															</a></li>
														<li id="menu-item-859" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-859"><a href="../../blog-masonry/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Blog Masonry</span></div>
															</a></li>
														<li id="menu-item-858" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-858"><a href="../../blog-classic/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Blog Classic</span></div>
															</a></li>
														<li id="menu-item-857" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-857"><a href="../../blog-list/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Blog List</span></div>
															</a></li>
													</ul>
												</li>
												<li id="menu-item-1817" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1817 level-1"><a href="../../shop/index.html">
														<div class="menu-item-wrap"><span class="menu-item-title">Shop</span><span class="toggle-sub-menu"> </span></div>
													</a>
													<ul class="sub-menu children simple-menu">
														<li id="menu-item-1825" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1825"><a href="../../shop/indexf43d.html?shop_archive_preset=left-sidebar">
																<div class="menu-item-wrap"><span class="menu-item-title">Shop Left Sidebar</span></div>
															</a></li>
														<li id="menu-item-1826" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1826"><a href="../../shop/index4527.html?shop_archive_preset=right-sidebar">
																<div class="menu-item-wrap"><span class="menu-item-title">Shop Right Sidebar</span></div>
															</a></li>
														<li id="menu-item-1821" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1821"><a href="../../cart/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Cart</span></div>
															</a></li>
														<li id="menu-item-1823" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1823"><a href="../../wishlist/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Wishlist</span></div>
															</a></li>
														<li id="menu-item-1820" class="menu-item menu-item-type-post_type menu-item-object-product menu-item-1820"><a href="../../shop/use-seo-to-boost-your-business/index.html">
																<div class="menu-item-wrap"><span class="menu-item-title">Single Product</span></div>
															</a></li>
													</ul>
												</li>
											</ul>
									...
									<div class="header-right">
										<div id="header-right-inner" class="header-right-inner">
											...
											<a href="../index.html" class="header-icon header-login-link">
								...
								<div class="row">
									<div class="col-md-12">
										<ul class="insight_core_breadcrumb">
											...
											<!-- <li class="level-1 top"><a href="../includes/all_student.php">All Students</a></li> -->
											<li class="level-2 sub tail current"><span><?= $result['stud_name'] ?></span></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="row">
						...
						<div id="page-main-content" class="page-main-content">
							...
							<div class="rich-snippet display-none">
								...
								<span class="updated" data-time="2022-09-23 23:17">2022-09-23 23:17</span>
							</div>
							...
							<article id="post-90" class="post-90 page type-page status-publish hentry pmpro-has-access post-no-thumbnail">
								...
								<div class="learnpress">
									...
									<div id="learn-press-user-profile" class="lp-user-profile guest">
											...
											<div class="row">
												<div class="col-md-5">
													<div class="lp-profile-cover">
														<div class="lp-profile-avatar"><img alt='User Avatar' src='<?= $result['image'] ?>' srcset='<?= $result['images'] ?>' class='avatar avatar-470 photo' style="height: 620px; width: 413px;" loading='lazy' /></div>
													</div>
												</div>

												<div class="col-md-6 col-md-push-1">
													<div class="lp-profile-info">
														<h3 class="profile-name"><?= $result['stud_name'] ?></h3>
														<div class="author-career"> / <?= $result['sc_name'] ?> / SLMS-No : <?= $result['slms_no'] ?> </div>

														<h5 class="profile-contact-info" style="text-decoration: underline;">Student Information :</h5>
														<div class="profile-author-meta">
															...
															<div class="meta-item profile-author-email">
																...
																<div class="author-email">
																	<?= $result['f_occupation'] ?> </div>
															</div>
															<div class="meta-item profile-author-email">
																<span>Mothers Occupation :</span>
																<div class="author-email">
																	<?= $result['m_occupation'] ?> </div>
															</div>
															<div class="meta-item profile-author-email">
																<span>Gender :</span>
																<div class="author-email">
															...
															<div class="meta-item profile-author-email">
																<span>Current Studying :</span>
																<div class="author-email">
																	<?= $result['class'] ?> </div>
															</div>
															<div class="meta-item profile-author-email">
																<span>Division / Semester :</span>
																<div class="author-email">
																	<?= $result['ds'] ?> </div>
															</div>
															<div class="meta-item profile-author-email">
														...
														<div class="author-social-networks">
															<div class="inner">
																<a class="hint--bounce hint--top hint--primary" aria-label="Birth Certificate" href="<?= $result['birth_certificate'] ?>" target="_blank">
																	<!-- <i class="fa-regular fa-user"></i> -->
																	<i>👶</i>
																	<!-- <i class="fa-duotone fa-baby-carriage"></i> -->
																</a>
																<a class="hint--bounce hint--top hint--primary" aria-label="Fathers Adhar-Card" href="<?= $result['f_adhar'] ?>" target="_blank">
																	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" height="15px" style="padding-top:3px"><path d="M272 304h-96C78.8 304 0 382.8 0 480c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32C448 382.8 369.2 304 272 304zM48.99 464C56.89 400.9 110.8 352 176 352h96c65.16 0 119.1 48.95 127 112H48.99zM224 256c70.69 0 128-57.31 128-128c0-70.69-57.31-128-128-128S96 57.31 96 128C96 198.7 153.3 256 224 256zM224 48c44.11 0 80 35.89 80 80c0 44.11-35.89 80-80 80S144 172.1 144 128C144 83.89 179.9 48 224 48z"/></svg>
																</a>
																<a class="hint--bounce hint--top hint--primary" aria-label="Mothers Adhar-Card" href="<?= $result['m_adhar'] ?>" target="_blank">
																	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" height="15px" style="padding-top:3px"><path d="M272 304h-96C78.8 304 0 382.8 0 480c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32C448 382.8 369.2 304 272 304zM48.99 464C56.89 400.9 110.8 352 176 352h96c65.16 0 119.1 48.95 127 112H48.99zM224 256c70.69 0 128-57.31 128-128c0-70.69-57.31-128-128-128S96 57.31 96 128C96 198.7 153.3 256 224 256zM224 48c44.11 0 80 35.89 80 80c0 44.11-35.89 80-80 80S144 172.1 144 128C144 83.89 179.9 48 224 48z"/></svg>
										...
										<table class="table">
											<h3 class="profile-name" style="text-align: center">Student Education Journey</h3>

											<thead>
												<tr>
													<th scope="col">Course</th>
													<th scope="col">Division / Semester</th>
											...
											<tbody>
												<?php foreach ($result_course as $data) { ?>
													<tr>
														<td><?= $data['course'] ?></td>
														<td><?= $data['ds'] ?></td>
														<td><?= $data['marks'] ?></td>
 ...
 -->
	...
	<!-- <div id="popup-try-live-demo" class="popup-try-live-demo hidden">
		...
		<form method="post" class="try-live-demo-form">
			<input type="hidden" id="maxcoach_live_login_nonce" name="maxcoach_live_login_nonce" value="19bb8bcc9c" /><input type="hidden" name="_wp_http_referer" value="/main/profile/maggiestrickland/" /> <input type="hidden" name="action" value="maxcoach_live_login">
	...
	<script id='wpems-countdown-js-js-extra'>
		...
		var WPEMS = {
			"gmt_offset": "0",
			"current_time": "Sep 24, 2022 03:57:00 +0000",
			"l18n": {
	...
	<script id='wp-api-fetch-js-after'>
		wp.apiFetch.use(wp.apiFetch.createRootURLMiddleware("../json/index.html"));
...
<!-- Mirrored from maxcoach.thememove.com/main/profile/maggiestrickland/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Sep 2022 05:22:19 GMT -->
