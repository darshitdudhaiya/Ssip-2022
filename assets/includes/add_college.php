...
<head>
    ...
    <title>Add College &rarr; SLMS</title>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Add College</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="learnpress">
                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-register-wrap col-md-6 col-md-push-3">
                                        ...
                                        <div class="learn-press-form-register learn-press-form">
                                            ...
                                            <form name="learn-press-register" method="post" action="<?= urlOf('assets/codes/add_college_code.php') ?>" enctype="multipart/form-data">
                                                <ul class="form-fields">
                                                    <li class="form-field">
                                                        <label for="reg_username">Index No.&nbsp;<span>*</span></label>
                                                        <input id="number" name="index_no" type="number" placeholder="Enter Index Number : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">College Name&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="c_name" type="text" placeholder="Enter College name : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Create College Password&nbsp;<span class="required">*</span></label>
                                                        <input id="schoolname" name="password" type="text" placeholder="Create College Password : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_email">College Establish Date&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="date" type="date" placeholder="Enter University Email : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_username">Website&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="website" type="text" placeholder="Enter Website URL : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Email&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="email" type="email" placeholder="Enter Email : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Address&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="address" type="text" placeholder="Enter Address : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <datalist id="district">
                                                            ...
                                                            <option value=Aravalli></option>
                                                            <option value=Banaskantha></option>
                                                            <option value=Bharuch></option>
                                                            <option value=Bhavnagar></option>
                                                            <option value=Botad></option>
                                                            <option value=Chhota-Udaipur></option>
                                                            <option value=Dahod></option>
                                                            <option value=Dang></option>
                                                            <option value=Devbhoomi-Dwarka></option>
                                                            <option value=Gandhinagar></option>
                                                            <option value=Gir-Somnath></option>
                                                            <option value=Jamnagar></option>
                                                            <option value=Junagadh></option>
                                                            <option value=Kutch></option>
                                                            <option value=Kheda></option>
                                                            <option value=Mahisagar></option>
                                                            <option value=Mehsana></option>
                                                            <option value=Morbi></option>
                                                            <option value=Narmada></option>
                                                            <option value=Navsari></option>
                                                            <option value=Panchmahal></option>
                                                            <option value=Patan></option>
                                                            <option value=Porbandar></option>
                                                            <option value=Rajkot></option>
                                                            <option value=Sabarkantha></option>
                                                            <option value=Surat></option>
                                                            <option value=Surendranagar></option>
                                                            <option value=Tapi></option>
                                                            <option value=Vadodara></option>
                                                            <option value=Valsad></option>
                                                            <option value=Bavla></option>
                                                            <option value=Daskroi></option>
                                                            <option value=Detroj-Rampura></option>
                                                            <option value=Dhandhuka></option>
                                                            <option value=Dholera></option>
                                                            <option value=Dholka></option>
                                                            <option value=Mandal></option>
                                                            <option value=Sanand></option>
                                                            <option value=Viramgam></option>
                                                            <option value=Babra></option>
                                                            <option value=Bagasara></option>
                                                            <option value=Dhari></option>
                                                            <option value=Jafrabad></option>
                                                            <option value=Khambha></option>
                                                            <option value=Kunkavav-vadia></option>
                                                            <option value=Lathi></option>
                                                            <option value=Lilia></option>
                                                            <option value=Rajula></option>
                                                            <option value=Savarkundla></option>
                                                            <option value=Anklav></option>
                                                            <option value=Borsad></option>
                                                            <option value=Khambhat></option>
                                                            <option value=Petlad></option>
                                                            <option value=Sojitra></option>
                                                            <option value=Tarapur></option>
                                                            <option value=Umreth></option>
                                                            <option value=Bayad></option>
                                                            <option value=Bhiloda></option>
                                                            <option value=Dhansura></option>
                                                            <option value=Malpur></option>
                                                            <option value=Meghraj></option>
                                                            <option value=Modasa></option>
                                                            <option value=Amirgadh></option>
                                                            <option value=Bhabhar></option>
                                                            <option value=Danta></option>
                                                            <option value=Dantiwada></option>
                                                            <option value=Deesa></option>
                                                            <option value=Deodar></option>
                                                            <option value=Dhanera></option>
                                                            <option value=Kankrej></option>
                                                            <option value=Lakhani></option>
                                                            <option value=Palanpur></option>
                                                            <option value=Suigam></option>
                                                            <option value=Tharad></option>
                                                            <option value=Vadgam></option>
                                                            <option value=Vav></option>
                                                            <option value=Amod></option>
                                                            <option value=Ankleshwar></option>
                                                            <option value=Hansot></option>
                                                            <option value=Jambusar></option>
                                                            <option value=Jhagadia></option>
                                                            <option value=Netrang></option>
                                                            <option value=Vagra></option>
                                                            <option value=Valia></option>
                                                            <option value=Gariadhar></option>
                                                            <option value=Ghogha></option>
                                                            <option value=Jesar></option>
                                                            <option value=Mahuva></option>
                                                            <option value=Palitana></option>
                                                        </datalist>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your University&nbsp;<span>*</span></label>
                                                        <input list="university" name="university" required>
                                                        <datalist id="university">
                                                            <option value="Gujarat Vidyapith"></option>
                                                            <option value="Central University of Gujarat (CUG)"></option>
                                                            <option value="Sumandeep Vidyapith (Deemed University)"></option>
                                                            <option value="Gujarat University"></option>
                                                            <option value="Sardar Patel University"></option>
                                                            <option value="Veer Narmad South Gujarat University"></option>
                                                            <option value="The Maharaja Sayajirao University (M.S.University)"></option>
                                                            <option value="Saurashtra University"></option>
                                                            <option value="Bhavnagar University"></option>
                                                            <option value="Hemchandracharya North Gujarat University (NGU)"></option>
                                                            <option value="Krantiguru Shyamji Krishna Verma Kachchh University"></option>
                                                            <option value="Dr. Babasaheb Ambedkar Open University (BAOU)"></option>
                                                            <option value="Shree Somnath Sanskrit University"></option>
                                                            <option value="Children's University Gujarat"></option>
                                                            <option value="Gujarat Forensic Sciences University (GFSU)"></option>
                                                            <option value="Raksha Shakti University"></option>
                                                            <option value="Kamdhenu University"></option>
                                                            <option value="The Indian Institute of Teacher Education"></option>
                                                            <option value="Gujarat Technological University"></option>
                                                            <option value="Gujarat Ayurved University"></option>
                                                            <option value="Institute of Infrastructure Technology Research And Management"></option>
                                                            <option value="Agricultural University"></option>
                                                            <option value="Anand Agricultural University"></option>
                                                            <option value="Navsari Agricultural University"></option>
                                                            <option value="Sardarkrushinagar Dantiwada Agricultural University"></option>
                                                            <option value="Junagadh Agricultural University"></option>
                                                            <option value="Dharamsinh Desai University (DDIT)"></option>
                                                            <option value="Centre for Environmental Planning and Technology (CEPT University)"></option>
                                                            <option value="Nirama University (NU)"></option>
                                                            <option value="Ganpat University"></option>
                                                            <option value="Dhirubhai Ambani Institute of Information and Communication Technology (DA-IICT)"></option>
                                                            <option value="Pandit Deendayal Petroleum University (PDPU)"></option>
                                                            <option value="Kadi Sarva Vishwavidyalaya"></option>
                                                            <option value="Calorx Teachers' University"></option>
                                                            <option value="Charotar University of Science & Technology"></option>
                                                            <option value="Navrachana University"></option>
                                                            <option value="Amadavad University"></option>
                                                            <option value="Auro University of Hospitality and Management"></option>
                                                            <option value="Uka Tarsadia University"></option>
                                                            <option value="R.K.University"></option>
                                                            <option value="Institute of Advanced Research"></option>
                                                            <option value="Lakulish Yoga University"></option>
                                                            <option value="Team Lease Skills University"></option>
                                                            <option value="C.U.Shah Unviersity Wadhwan City"></option>
                                                            <option value="ITM Vocational University-Waghodia"></option>
                                                            <option value="Indus University"></option>
                                                            <option value="Rai University"></option>
                                                            <option value="ITM Vocational University"></option>
                                                            <option value="GSFC University"></option>
                                                            <option value="GLS University"></option>
                                                            <option value="Parul University"></option>
                                                            <option value="Sankalchand Patel University"></option>
                                                            <option value="Marwadi University"></option>
                                                            <option value="Plastindia International University"></option>
                                                            <option value="Anant National University"></option>
                                                            <option value="Swarnim Startup and Innovation University"></option>
                                                            <option value="P.P.Savani University"></option>
                                                            <option value="Indrashil University"></option>
                                                            <option value="Karnavati University"></option>
                                                            <option value="Gujarat Maritime University"></option>
                                                            <option value="Indian Institute of Management, Ahmedabad(IIM-A)"></option>
                                                            <option value="Indian Institute of Technology (IIT)"></option>
                                                            <option value="Sardar Vallabhbhai National Institute of Technology ,Surat (SVNIT)"></option>
                                                            <option value="National Institute of Design ,Ahmedabad (NID)"></option>
                                                            <option value="Physical Research Laboratory (PRL)"></option>
                                                            <option value="Entrepreneurship Development Institute of India"></option>
                                                        </datalist>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Upload College Image&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="image" type="file" placeholder="Upload Student Image : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Description&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="description" type="text" placeholder="Description " autocomplete="number" value="" required>
                                                    </li>
                                                </ul>
                                                <p>
