...
$update_pstudr = "UPDATE pstudr SET status='remarked' WHERE id='$id'";
...
<head>
    ...
    <title>Student Remark &rarr; SLMS</title>
                        ...
                        <div class="row row-xs-center">
                            <div class="col-md-12">
                                ...
                                <div class="page-title-bar-heading">
                                    <h1 class="heading"> Remark Student</h1>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Remark Student</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                                                        ...
                                                                                        <div class="post-wrapper maxcoach-box">
                                                                                            <div class="post-thumbnail-wrapper">
                                                                                                <div class="post-feature post-thumbnail maxcoach-image school-image">
                                                                                                    <a href="#">
                                                                                                        <img src="<?= $result['image'] ?>" alt="home-personal-finance-blog-03" />
                                                                                                    </a>
                                                                                            ...
                                                                                            <div class="post-caption">
                                                                                                ...
                                                                                                <h3 class="post-title">
                                                                                                    <a href="#" target="_blank" class="scname" title="<?= $result['stud_name'] ?>"><?= $result['stud_name'] ?></a>
                                                                                                </h3>
                                                                                                <div class="post-meta">
                                                                                                    <div class="inner">
                                                                                                        <div class="post-date">
                                                                                                ...
                                                                                                <div class="post-excerpt">
                                                                                                    <input type="text" name="remark" id="" style="height: 200px;" placeholder="Enter your Remark: ">
                                                                                                </div>
                                                                                                <!-- <?php if (isset($_SESSION['user'])) { ?>
                                                                                                                        ...
                                                                                                                        <div class="share-list">
                                                                                                                            ...
                                                                                                                            <form action="./all_student.php" method="post">
                                                                                                                                <a class="hint--bounce hint--top hint--primary twitter" target="_self" aria-label="View Student" href="../includes/all_student.php">
                                                                                                                                    <button type="submit" value="<?= $ans["s_name"] ?>" name="view" style="background-color:grey; border-color:grey"><i class="fab fa fa-eye"></i></button>
                                                                                                                                </a>
                                                                                                                            </form>
                                                                                                    ...
                                                                                                    <div class="post-meta row" style="margin-left:180px">
                                                                                                        <div class="inner">
                                                                                                            <div class="post-view col-md-3">
                                                                                                                <span class="meta-icon">
                                                                                                                    <label for="">BIrth Certificate</label>
                                                                                                                    <!-- <i class="far fa-phone"></i> -->
                                                                                                                </span>
                                                                                                                <iframe src="<?= $result['birth_certificate'] ?>" frameborder="1" stuyle></iframe>
                                                                                                            </div>
                                                                                                            <div class="post-view col-md-3">
                                                                                                                <span class="meta-icon">
                                                                                                                    <label for="">Fathers Adharcard</label>
                                                                                                                    <!-- <i class="far fa-phone"></i> -->
                                                                                                                </span>
                                                                                                                <iframe src="<?= $result['f_adhar'] ?>" frameborder="1"></iframe>
                                                                                                            </div>
                                                                                                            <div class="post-view col-md-3">
                                                                                                                <span class="meta-icon">
                                                                                                                    <label for="">Mothers Adharcard</label>
                                                                                                                    <!-- <i class="far fa-phone"></i> -->
                                                                                                                </span>
                                                                                                                <iframe src="<?= $result['m_adhar'] ?>" frameborder="1"></iframe>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
