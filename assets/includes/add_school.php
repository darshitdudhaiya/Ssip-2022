...
<head>
    ...
    <title>Add School &rarr; SLMS</title>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Add School</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="learnpress">
                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-register-wrap col-md-6 col-md-push-3">
                                        ...
                                        <div class="learn-press-form-register learn-press-form">
                                            ...
                                            <h3 style="text-align: center;">Add School</h3>

                                            <form name="learn-press-register" method="post" action="<?= urlOf('assets/codes/add_school_code.php') ?>" enctype="multipart/form-data">
                                                <ul class="form-fields">
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_name">School Name&nbsp;<span class="required">*</span></label>
                                                        <input id="schoolname" name="s_name" type="text" placeholder="Enter School name : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Create School Password&nbsp;<span class="required">*</span></label>
                                                        <input id="schoolname" name="password" type="text" placeholder="Create School Password : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_email">School Establish Date&nbsp;<span class="required">*</span></label>
                                                        <input id="edate" name="date" type="date" placeholder="Enter University Email : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Number&nbsp;<span>*</span></label>
                                                        <input id="number" name="number" type="number" placeholder="Enter Number : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Alternate Number&nbsp;<span>*</span></label>
                                                        <input id="anumber" name="a_number" type="number" placeholder="Enter Alternate Number : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Website &nbsp;<span>*</span></label>
                                                        <input id="anumber" name="website" type="text" placeholder="Enter Website URL : " autocomplete="number" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Email&nbsp;<span>*</span></label>
                                                        <input id="email" name="email" type="email" placeholder="Enter Email : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Address&nbsp;<span>*</span></label>
                                                        <input id="address" name="address" type="text" placeholder="Enter Address : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <input list="board" name="board" required>
                                                        <datalist id="board">
                                                            <option value=GS&HSEB></option>
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_username">Upload School Image&nbsp;<span>*</span></label>
                                                        <input id="simage" name="image" type="file" placeholder="Upload Student Image : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Description&nbsp;<span>*</span></label>
                                                        <input id="description" name="description" type="text" placeholder="Description " autocomplete="number" value="" required>
                                                    </li>
                                                </ul>
                                                <p>
                                                    ...
                                                    <button type="submit" id="addschool">Add School</button>
                                                </p>
...
<?php include('../includes/footer.php');  ?>
 ...
 -->
    ...
    $("#addschool").click(function(e)
    {
        ...
        $.ajax({
            url:"/ssip/assets/codes/add_school_code.php",
            type : 'POST',
