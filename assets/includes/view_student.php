...
$result = $query->fetch();
$slms_no = $result['slms_no'];
// print_r($result['slms_no']);
...
<head>
	...
	<title>View Student &rarr; SLMS</title>
											...
											<div class="row">
												<div class="col-md-5">
													<div class="lp-profile-cover">
														<div class="lp-profile-avatar"><img alt='User Avatar' src='<?= $result['image'] ?>' srcset='<?= $result['images'] ?>' class='avatar avatar-470 photo' loading='lazy' style="height:620px; width:413px" /></div>
													</div>
												</div>
												...
												<div class="col-md-6 col-md-push-1">
													<div class="lp-profile-info">
														...
														<h5 class="profile-contact-info">Information</h5>
														<div class="profile-author-meta">
															...
															<div class="meta-item profile-author-email">
																<span>Marks of Previous Year :</span>
																<div class="author-email">
																	<?= $result['marks'] ?> </div>
															</div>
															<div class="meta-item profile-author-email">
