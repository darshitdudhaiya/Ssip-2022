                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Student Profile</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="learnpress">
                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-login-wrap col-md-5 col-md-push-4">
                                        ...
                                        <div class="learn-press-form-login learn-press-form">
                                            ...
                                            <form id="form" method="post" action="../includes/show_student.php">
                                                <ul class="form-fields">
                                                    <li class="form-field">
                                                        <label for="username">SLMS No &nbsp;<span class="required">*</span></label>
                                                        <input type="number" name="slms_no" id="username" placeholder="SLMS No :" autocomplete="username" />
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="password">Password&nbsp;<span class="required">*</span></label>
                                                        <input id="password" type="password" name="slms_password" id="password" placeholder="Password" autocomplete="current-password" />
                                                    </li>
                                                    <!-- <input type="submit" value="Submit"> -->
                                                    <!-- <li class="form-field">
                                                        <label for="password">Password&nbsp;<span class="required">*</span></label>
                                                        <input id="login" type="submit" name="slms_password" value="Submit" />
                                                    </li> -->
                                                    <div class="col lost-your-password-wrap">
                                                        <p>
                                            ...
                                            <!-- <form action="../includes/show_student.php" method="post">
                                                <input type="number" name="slms_no" placeholder="Enter SLMS number : ">
                                                <input type="password" name="slms_password" placeholder="Enter SLMS password : ">
                                                <input type="submit" value="Submit">
                                            </form> -->
                                        </div>
