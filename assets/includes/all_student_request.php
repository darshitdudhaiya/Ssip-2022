...
// $name = $_POST['view'];
$select = "SELECT * FROM pstudr WHERE status = 'pending' ";
                        ...
                        <div class="row row-xs-center">
                            <div class="col-md-12">
                                ...
                                <div class="page-title-bar-heading">
                                    <h1 class="heading"> Requested Students </h1>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Requested Students</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div id="page-main-content" class="page-main-content">
                            ...
                            <table class="table" id="myTable" style="margin-left: -100px;">
                                <thead>
                                    <tr>
                                        <!-- <th scope="col">SLMS No</th> -->
                                ...
                                <tbody>
                                    ...
                                    foreach ($result as $data) { ?>
                                        <tr>
                                            <td><?= $data['sc_name']?$data['sc_name']:$data['c_name'] ?></a></td>
                                            ...
                                            <td><?= $data['board'] ?></td>
                                            <!-- <td><?= $data['image'] ?></td> -->
                                            <td><a href="<?= $data['birth_certificate'] ?>" target="_blank">Birth Certificate</a></td>
                                            <td><a href="<?= $data['f_adhar'] ?>" target="_blank">Father AC</a></td>
                                            <td><a href="<?= $data['m_adhar'] ?>" target="_blank">Mother AC</a></td>
                                            <td><a href="../codes/add_student_accept.php?id=<?= $data['id'] ?>" style="color: green; font-size:25px">✓</a></td>
                                            <td><a href="../codes/add_student_reject.php?id=<?= $data['id'] ?>">❌</a></td>
                                            <td><button href="/" style="font-size:18px;border:none;background:none;" id="model" value="<?= $data['id'] ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">✏️</button></td>
                                        </tr>
                                        <?php } ?>
                                        ...
                                        <script>
                                            $(document).on("click","#model",function(){
                                                ...
                                                $.ajax({
                                                    url : "/ssip/assets/codes/request_model.php",
                                                    data : { id : no},
                                                    type : "POST",
                                                    success : function(data){
                                                        let dd = JSON.parse(data);
                                                        $("#container-name").html('<span>Student Name :</span><span class="modal-title fs-7 fw-semibold ps-1" id="exampleModalLabel">'+dd.name+'</h1>');
                                                        $("#container-adhar").html('<span>AdharCard-Number :</span><span class="modal-title fs-7 fw-semibold ps-1" id="exampleModalLabel">'+dd.adhar+'</h1>');
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Remark Student</h1>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="../codes/add_student_remarked.php" method="post">
                                                            <input type="hidden" name="id" id="model-id" value="<?=$data["id"] ?>">
                                                            <div class="container" id="container-name">
                                                               
                                                            </div>
                                                            <div class="container  pb-4" id="container-adhar">
                                                            </div>
                                                            <div class="input-group pb-4">
                                                                <span class="input-group-text">Remark : </span>
                                                                <textarea class="form-control" aria-label="With textarea" name="remark" required></textarea>
                                                            </div>
                                                            <div class="input-group form-check ps-5">
                                                                <input class="form-check-input mt-1" type="checkbox" name="birth_certificate_check" checked>
                                                                <label class="form-check-label" for="flexCheckChecked">
                                                                    Birth Certificate
                                                                </label>
                                                            </div>
                                                            <div class="input-group form-check ps-5">
                                                                <input class="form-check-input mt-1" type="checkbox" id="flexCheckChecked" name="f_adhar_check" checked>
                                                                <label class="form-check-label" for="flexCheckChecked">
                                                                    Father Adhar-Card
                                                                </label>
                                                            </div>
                                                            <div class="input-group form-check ps-5">
                                                                <input class="form-check-input mt-1" type="checkbox" id="flexCheckChecked" name="m_adhar_check" checked>
                                                                <label class="form-check-label" for="flexCheckChecked">
                                                                    Mother Adhar-Card
                                                                </label>
                                                            </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <!-- <a href="../codes/add_student_remarked.php?id=<?= $data['id'] ?>"> -->
                                                        <button type="submit" class="btn btn-success">Remark</button>
                                                        <!-- </a> -->
                                                    </div>
                                                    </form>
                                                </div>
