...
$select_scl = "SELECT * FROM schools";
$query_scl = $connection->query($select_scl);
$result_scl = $query_scl->fetchAll(PDO::FETCH_ASSOC);

$select_emp = "SELECT * FROM emp";
$query_emp = $connection->query($select_emp);
$result_emp = $query_emp->fetchAll(PDO::FETCH_ASSOC);
// print_r($result);
?>
<!DOCTYPE html>
<html lang="en-US">
...
<head>
    ...
    <style id="kirki-inline-styles">
        ...
        .bac {
            background-image: url(../images/tricolor-brush.jpg);
            background-size: cover;
                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-login-wrap col-md-5 col-md-push-4">
                                        ...
                                        <div class="learn-press-form-login learn-press-form">
                                            ...
                                            <form id="form" name="learn-press-login" method="post">
                                                <!-- <form method="get" action="../includes/login.php"> -->
                                                <?php $panel = $_GET['panel'] ?>
                                                <select id="user_type" onchange="showpanel()">
                                                    <option value="Government Panel" <?= $panel == 'Government Panel' ? "selected" : '' ?>>Government Panel</option>
                                                    <option value="Edu-Department Panel" <?= $panel == 'Edu-Department Panel' ? "selected" : '' ?>>Edu-Department Panel</option>
                                                    <option value="Employee Panel" <?= $panel == 'Employee Panel' ? "selected" : '' ?>>Employee Panel</option>
                                                    <option value="College Panel" <?= $panel == 'College Panel' ? "selected" : '' ?>>College Panel</option>
                                                    <option value="School Panel" <?= $panel == 'School Panel' ? "selected" : '' ?>>School Panel</option>
                                                    <option value="University Panel" <?= $panel == 'University Panel' ? "selected" : '' ?>>University Panel</option>
                                                </select>
                                                <!-- </form> -->
                                                <br><br>
                                                <ul class="form-fields">
                                                    <?php if ($panel == 'Government Panel') { ?>
                                                        <li class="form-field">
                                                            <label for="username">SLMS No or Username&nbsp;<span class="required">*</span></label>
                                                            <input id="email" type="text" name="username" id="username" placeholder="SLMS No or Username :" autocomplete="username" value="Government of Gujarat" disabled />
                                                        </li>
                                                    <?php } ?>
                                                    <?php if ($panel == 'Edu-Department Panel') { ?>
                                                        <li class="form-field">
                                                            <label for="username">SLMS No or Username&nbsp;<span class="required">*</span></label>
                                                            <input id="email" type="text" name="username" id="username" placeholder="SLMS No or Username :" autocomplete="username" value="Education Department of Gujarat" disabled />
                                                        </li>
                                                    <?php } ?>
                                                    <?php if ($panel == 'Employee Panel') { ?>
                                                        <li class="form-field">
                                                            <label for="reg_username">Employee Name&nbsp;<span>*</span></label>
                                                            <!-- <input list="class" name="sc_name" value=""> -->
                                                            <select id="email">
                                                                <?php foreach ($result_emp as $ans_all) { ?>
                                                                    <option value="<?= $ans_all['emp_name'] ?>"><?= $ans_all['emp_name'] ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if ($panel == 'College Panel') { ?>
                                                        <li class="form-field">
                                                            <label for="reg_username">College Name&nbsp;<span>*</span></label>
                                                            <!-- <input list="class" name="sc_name" value=""> -->
                                                            <select id="email">
                                                                <?php foreach ($result_all as $ans_all) { ?>
                                                                    <option value="<?= $ans_all['c_name'] ?>"><?= $ans_all['c_name'] ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if ($panel == 'School Panel') { ?>
                                                        <li class="form-field">
                                                            <label for="reg_username">School Name&nbsp;<span>*</span></label>
                                                            <!-- <input list="class" name="sc_name" value=""> -->
                                                            <select id="email" name="username">
                                                                <?php foreach ($result_scl as $ans_all) { ?>
                                                                    <option value="<?= $ans_all['s_name'] ?>"><?= $ans_all['s_name'] ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if ($panel == 'University Panel') { ?>
                                                        <li class="form-field">
                                                            <label for="reg_username">University Name&nbsp;<span>*</span></label>
                                                            <!-- <input list="class" name="sc_name" value=""> -->
                                                            <select id="email" name="username">
                                                                <?php foreach ($result_scl as $ans_all) { ?>
                                                                    <option value="<?= $ans_all['s_name'] ?>"><?= $ans_all['s_name'] ?></option>
                                                    ...
                                                    <?php } ?>
                                                        <li class="form-field">
                                                            ...
                                                            <input id="password" type="password" name="password" id="password" placeholder="Password" autocomplete="current-password" />
                                                        </li>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-6 remember-me-wrap">
                                                        <p>
                                                            ...
                                                            <!-- Remember me </label> -->
                                                            <a href="../includes/student_login.php" class="lost-your-password">Student Login</a>
                                                        </p>
                                                    </div>
                                                    <div class="col-xs-6 lost-your-password-wrap">
                                                        <p>
                                                            <a href="./lostpassword_student.php" class="lost-your-password">Lost your password?</a>
                                                        </p>
                                                    </div>
                                                </div>
                                                <p>
 ...
 -->
    ...
    <script>
        $("#login").click(function(e) {
            ...
            $.ajax({
                url: "/ssip/assets/includes/user.php",
                type: 'POST',
                ...
                success: function(data) {
                    if (data == 1) {
                        ...
                        // if($panel){
                        open("../includes/show_school.php", "_self");
                        // }
                        // else{
    ...
    <script>
        function showpanel() {
            var panel = document.getElementById('user_type').value;
            window.location.href = "login.php?panel=" + panel;
        }
    </script>
</body>
