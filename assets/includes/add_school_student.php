...
$result = $query->fetch();
$select_all = "SELECT * FROM schools";
                                ...
                                <div class="learnpress">
                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-register-wrap col-md-6 col-md-push-3">
                                        ...
                                        <div class="learn-press-form-register learn-press-form">
                                            ...
                                            <form name="learn-press-register" method="post" action="<?= urlOf('assets/codes/request_student_code.php') ?>" enctype="multipart/form-data">
                                                <ul class="form-fields">

                                                    <li class="form-field">
                                                        <!-- <label for="reg_username">School Name&nbsp;<span>*</span></label> -->
                                                        <input list="class" name="sc_name" type="hidden" value="<?= $result['s_name'] ?>">
                                                        <!-- <datalist id="class"> -->
                                                    </li>
                                                    <!-- <li class="form-field">
                                                        <label for="reg_name">SLMS No &nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="slms_no" type="number" autocomplete="name" placeholder="SLMS No : " required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">SLMS Password &nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="slms_password" type="password" autocomplete="name" placeholder="SLMS Password : " required>
                                                    </li> -->
                                                    <li class="form-field">
                                                    ...
                                                    <!-- <li class="form-field">
                                                        <label for="reg_username">Blood Group&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_username" name="blood" type="text" placeholder="Enter Blood Group :  " autocomplete="number" value="" required>
                                                    </li> -->
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_username">Adharcard Number&nbsp;<span>*</span></label>
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your Division&nbsp;<span>*</span></label>
                                                        <input list="course" name="ds" required>
                                                        <datalist id="course">
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your Board&nbsp;<span>*</span></label>
                                                        <input type="text" name="board" value="<?= $result['board'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
