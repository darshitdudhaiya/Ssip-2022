...
<head>
    ...
    <title>Universities &rarr; SLMS</title>
                                            ...
                                            <ul id="menu-primary" class="menu__container sm sm-simple">
                                                                                                                    ...
                                                                                                                    <div class="elementor-widget-container">
                                                                                                                        <div class="elementor-image">
                                                                                                                            <a href="../../index.php" target="_blank" rel="nofollow">
                                                                                                                                <img width="600" height="257" src="../images/Seal_of_Gujarat.jpg" class="attachment-full size-full" alt="" loading="lazy" srcset="../images/Seal_of_Gujarat.jpg 600w, ../images/Seal_of_Gujarat.jpg 300w" sizes="(max-width: 600px) 100vw, 600px" />
                                                                                                                            </a>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                ...
                                                <li id="menu-item-20" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-20 level-1">
                                                    <?php if (isset($_SESSION["user_type"])) { ?>
                                                        <?php if ($_SESSION['user_type'] == 'Government Panel' || $_SESSION["user_type"] == 'University Panel') { ?>
                                                            <a href="#">
                                                                <div class="menu-item-wrap"><span class="menu-item-title">Feature</span><span class="toggle-sub-menu"> </span></div>
                                                            </a>
															...
															<a href="<?= urlOf('assets/includes/login.php') ?>">
                                                                ...
                                                                <?php if ($_SESSION["user_type"] == 'Government Panel') { ?>
                                                                    <li id="menu-item-1851" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1851">
                                                                        <a href="<?= urlOf('assets/includes/add_university.php') ?>">
                                                                            <div class="menu-item-wrap"><span class="menu-item-title">Add University</span>
                                                                            </div>
                                                                        </a>
                                                                    </li>
                                                                <?php } ?>
                                                                <?php if ($_SESSION["user_type"] == 'Government Panel') { ?>
                                                                    <li id="menu-item-424" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-424">
                                                                        <a href="<?= urlOf('assets/includes/add_school.php') ?>">
                                                                            <div class="menu-item-wrap"><span class="menu-item-title">Add School</span></div>
                                                                        </a>
                                                                    </li>
                                                                <?php } ?>
                                                                <?php if ($_SESSION["user_type"] == 'Government Panel' || $_SESSION["user_type"] == 'University Panel') { ?>
                                                                    <li id="menu-item-423" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-423">
                                                                        <a href="<?= urlOf('assets/includes/add_college.php') ?>">
                                                                            <div class="menu-item-wrap"><span class="menu-item-title">Add College</span></div>
                                                                        </a>
                                                                    </li>
                                                                <?php } ?>
                                                                <?php if ($_SESSION["user_type"] == 'Government Panel') { ?>
                                                                    <li id="menu-item-423" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-423">
                                                                        <a href="#">
                                                                            <div class="menu-item-wrap"><span class="menu-item-title">Add Board</span></div>
                                                                        </a>
                                                                    </li>
                                                                <?php } ?>
                                                ...
                                                <li id="menu-item-3338" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3338 level-1">
                                                    <a href="../includes/all_universities.php">
                                                        <div class="menu-item-wrap"><span class="menu-item-title">University</span></div>
                                                    </a>
                                                </li>
                                                <li id="menu-item-3338" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3338 level-1">
                                                    <a href="../includes/all_colleges.php">
                                                ...
                                                <li id="menu-item-1652" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1652 level-1">
                                                    <a href="../includes/all_schools.php">
                                                        <div class="menu-item-wrap"><span class="menu-item-title">Schools</span></div>
                                                    </a>
                                                </li>
                                                <li id="menu-item-1817" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1817 level-1">
                                                    <a href="#">
                                                        <div class="menu-item-wrap"><span class="menu-item-title">Report</span></div>
                                                    </a>
                                                </li>
                                            </ul>
                                        </nav>
                                    ...
                                    <div class="header-right">
                                        <?php if (!isset($_SESSION['user_type'])) { ?>
                                            <div id="header-right-inner" class="header-right-inner">
                                                <a href="<?= urlOf('assets/includes/login.php') ?>" class="header-icon header-login-link">
                                                    <i class="far fa-user-circle"></i>
                                                </a>
                                            <?php } ?>
                                            <?php if (isset($_SESSION['user_type'])) { ?>
                                                <a href="<?= urlOf('assets/codes/logout.php') ?>">
                                                    <div class="menu-item-wrap"><span class="menu-item-title" style="color:white">Log Out</span></div>
                                                </a>
                                            <?php } ?>
                                            </div>
                        ...
                        <div class="row row-xs-center">
                            <div class="col-md-12">
                                ...
                                <div class="page-title-bar-heading">
                                    <h1 class="heading"> Universities </h1>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Universities</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div id="page-main-content" class="page-main-content">
                            ...
                            <div class="rich-snippet display-none">
                                <h1 class="entry-title">Blog List</h1> <span class="published">Dec 11, 2019</span>
                                <span class="updated" data-time="2019-12-12 4:23">2019-12-12 4:23</span>
                            </div>


                            <article id="post-851" class="post-851 page type-page status-publish hentry pmpro-has-access post-no-thumbnail">
                                <h2 class="screen-reader-text">Blog List</h2>
                                                                                    ...
                                                                                    <div class="grid-item post-item post-5168 post type-post status-publish format-video has-post-thumbnail hentry category-business tag-finance post_format-post-format-video pmpro-has-access">
                                                                                        <div class="post-wrapper maxcoach-box">
                                                                                            <div class="post-thumbnail-wrapper">
                                                                                                <div class="post-feature post-thumbnail maxcoach-image school-image">
                                                                                                    <a href="#">
                                                                                                        <img src="<?= $ans['s_image'] ?>" alt="home-personal-finance-blog-03"  />
                                                                                                    </a>
                                                                                            ...
                                                                                            <div class="post-caption">
                                                                                                ...
                                                                                                <h3 class="post-title">
                                                                                                    <a href="./all_student.php?id=<?= $ans["id"] ?>" title="<?= $ans['s_name'] ?>"><?= $ans['s_name'] ?></a>
                                                                                                </h3>
                                                                                                <div class="post-meta">
                                                                                                    <div class="inner">
                                                                                                        <div class="post-date">
                                                                                                ...
                                                                                                <div class="post-excerpt">
                                                                                                    <p title="<?= $ans['description'] ?>"><?= $ans['description'] ?>
                                                                                                    </p>
                                                                                                </div>
                                                                                                    ...
                                                                                                    <?php if ($_SESSION["user_type"] == 'Government Panel' || $_SESSION["user_type"] == 'University Panel') { ?>
                                                                                                        <div class="post-footer">
                                                                                                            <div class="post-share style-01">
                                                                                                                <div class="share-label">Do More</div>
                                                                                                                <div class="share-media">
                                                                                                                    <span class="share-icon fas fa-share-alt"></span>

                                                                                                                    <div class="share-list">
                                                                                                                        <a class="hint--bounce hint--top hint--primary facebook" target="_self" aria-label="Add Student" href="../includes/add_student.php?id=<?= $ans['id'] ?>">
                                                                                                                            <i class="fab fa fa-plus"></i>
                                                                                                                        </a>
                                                                                                                        <a class="hint--bounce hint--top hint--primary twitter" target="_self" aria-label="View Student" href="../includes/all_student.php?id=<?= $ans['id'] ?>">
                                                                                                                            <i class="fab fa fa-eye"></i>
                                                                                                                        </a>
                                                                                                                        <a class="hint--bounce hint--top hint--primary linkedin" target="_self" aria-label="Update" href="#">
                                                                                ...
                                                                                <div class="maxcoach-grid-pagination">
                                                                                    <div class="pagination-wrapper">
                                                                                        ...
                                                                                        <ul class="page-pagination">
                                                                                            ...
                                                                                            <li><a class="page-numbers" href="page/7/index.html">7</a></li>
 ...
 -->
        ...
        <div class="inner">
            ...
            <div class="page-mobile-menu-content">
                <ul id="mobile-menu-primary" class="menu__container">
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-14 level-1 has-mega-menu"><a href="../../index.php">
                            <div class="menu-item-wrap"><span class="menu-item-title">Home</span><span class="toggle-sub-menu"> </span></div>
                        </a>
                        <ul class="sub-menu children mega-menu">
                    ...
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-20 level-1"><a href="#">
                        ...
                        <ul class="sub-menu children simple-menu">
                            ...
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-1660"><a href="../privacy-policy/index.html">
                    ...
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-97 level-1"><a href="../courses/index.html">
                        ...
                        <ul class="sub-menu children simple-menu">
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1539"><a href="../profile/maggiestrickland/index.html">
                            ...
                            <li class="menu-item menu-item-type-post_type menu-item-object-lp_course menu-item-has-children menu-item-124"><a href="../course/programming-for-everyone-python/index.html">
                                    <div class="menu-item-wrap"><span class="menu-item-title">Single Layout</span><span class="toggle-sub-menu"> </span></div>
                                </a>
                                <ul class="sub-menu children simple-menu">
                                    <li class="menu-item menu-item-type-post_type menu-item-object-lp_course menu-item-3347"><a href="../course/customer-centric-info-tech-strategies/index.html">
                                            <div class="menu-item-wrap"><span class="menu-item-title">Free Course</span></div>
                                        </a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-lp_course menu-item-125"><a href="../course/programming-for-everyone-python/index.html">
                                            <div class="menu-item-wrap"><span class="menu-item-title">Sticky Features Bar</span></div>
                                        </a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-lp_course menu-item-123"><a href="../course/master-jquery-in-a-short-time/index.html">
                                            <div class="menu-item-wrap"><span class="menu-item-title">Standard Sidebar</span></div>
                                        </a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-lp_course menu-item-128"><a href="../course/introduction-to-javascript-for-beginners/index.html">
                    ...
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3338 level-1"><a href="#">
                    ...
                    <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-1652 level-1"><a href="../blog/index.html">
                        ...
                        <ul class="sub-menu children simple-menu">
                            ...
                            <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-851 current_page_item menu-item-857"><a href="index.html">
                                    <div class="menu-item-wrap"><span class="menu-item-title">Blog List</span></div>
                                </a></li>
                        </ul>
                    </li>
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1817 level-1"><a href="../shop/index.html">
    ...
    <script id='elementor-frontend-js-before'>
        var elementorFrontendConfig = {
            ...
            "post": {
                "id": 851,
                "title": "Blog%20List%20%E2%80%93%20MaxCoach",
                "excerpt": "",
                "featuredImage": false
            }
        };
...
<!-- Mirrored from maxcoach.thememove.com/main/blog-list/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Sep 2022 05:24:48 GMT -->
