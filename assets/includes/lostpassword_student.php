                                        ...
                                        <div class="learn-press-form-login learn-press-form">
                                            ...
                                            <form id="form" name="learn-press-login" method="post">
                                                ...
                                                <ul class="form-fields">
                                                    <li class="form-field">
                                                        <label for="password">Enter Email&nbsp;<span class="required">*</span></label>
                                                        <input id="Email" type="text" name="password" placeholder="Enter Email" autocomplete="current-password" />
                                                    </li>
                                                </ul>
                                                <p>
 ...
 -->
    ...
    <script>
        $("#submit").click(function(e) {
            ...
            $.ajax({
                url: "/ssip/assets/codes/forgot_password_query.php",
                type: 'POST',
