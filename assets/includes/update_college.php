                                ...
                                <div class="learnpress">
                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-register-wrap col-md-6 col-md-push-3">
                                        ...
                                        <div class="learn-press-form-register learn-press-form">
                                            ...
                                            <form name="learn-press-register" method="post" action="<?= urlOf('assets/codes/update_college_code.php') ?>" enctype="multipart/form-data">
                                                <ul class="form-fields">
                                                    <li class="form-field">
                                                        <label for="reg_name">College Name&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="c_name" type="text" placeholder="Enter College name : " autocomplete="email" value="<?= $result['c_name'] ?>" required>
                                                        <input name="id" type="hidden" value="<?= $result['id'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_email">College Establish Date&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="date" type="date" placeholder="Enter University Email : " autocomplete="email" value="<?= $result['date'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Number&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="number" type="number" placeholder="Enter Number : " autocomplete="number" value="<?= $result['number'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Alternate Number&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="a_number" type="number" placeholder="Enter Alternate Number : " autocomplete="number" value="<?= $result['a_number'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Website&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="website" type="text" placeholder="Enter Website URL : " autocomplete="number" value="<?= $result['website'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Email&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="email" type="email" placeholder="Enter Email : " autocomplete="number" value="<?= $result['email'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Address&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="address" type="text" placeholder="Enter Address : " autocomplete="number" value="<?= $result['address'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <input list="university" name="university" required value="<?= $result['university'] ?>">
                                                        <datalist id="university">
                                                            <option value="Gujarat University">Gujarat University</option>
                                                            <option value="Saurastra University">Saurastra University</option>
                                                            <option value="Maharastra University">Maharastra University</option>
                                                        </datalist>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Preview of last Image&nbsp;<span>*</span></label>
                                                        <img src="<?= $result['c_image'] ?>" alt="" height="100px" width="100px">
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <input id="reg_username" name="description" type="text" placeholder="Description " autocomplete="number" value="<?= $result['description'] ?>" required>
                                                    </li>
                                                </ul>
                                                <p>
