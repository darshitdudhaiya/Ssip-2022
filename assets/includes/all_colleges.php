...
if (isset($_GET['search'])) {
    ...
    $recordCountSql = "SELECT count(*) as Count FROM colleges WHERE _name  LIKE '%$searchval%' || district  LIKE '%$searchval%' || board  LIKE '%$searchval%'";
    ...
    $select = "SELECT * FROM colleges WHERE s_name  LIKE '%$searchval%' OR district  LIKE '%$searchval%' OR board  LIKE '%$searchval%' LIMIT " . (($pageNo - 1) * $range) . ",$range";
...
elseif(isset($_GET['district'])) {
    ...
    $recordCountSql = "SELECT count(*) as Count FROM colleges WHERE district = '$districtval'";
    $result = $connection->query($recordCountSql);
    $countRecord = $result->fetchAll(PDO::FETCH_ASSOC)[0]["Count"];
    $pageCount = $countRecord % $range == 0 ? ($countRecord / $range) : intval($countRecord / $range) + 1;
    if (!isset($_GET["page"])) {
    ...
    $select = "SELECT * FROM colleges WHERE district = '$districtval' ORDER BY index_no LIMIT " . (($pageNo - 1) * $range) . ",$range";
    $query = $connection->query($select);
    $result = $query->fetchAll(PDO::FETCH_ASSOC);
}

else {
    $recordCountSql = "SELECT count(*) as Count FROM colleges";
    $result = $connection->query($recordCountSql);
    $countRecord = $result->fetchAll(PDO::FETCH_ASSOC)[0]["Count"];
    $pageCount = $countRecord % $range == 0 ? ($countRecord / $range) : intval($countRecord / $range) + 1;
    if (!isset($_GET["page"])) {
    ...
    $select = "SELECT * FROM colleges ORDER BY index_no LIMIT " . (($pageNo - 1) * $range) . ",$range";
    $query = $connection->query($select);
    $result = $query->fetchAll(PDO::FETCH_ASSOC);
}
$select_user = "SELECT * FROM users";
$query_user = $connection->query($select_user);
...
<head>
    ...
    <title>Colleges &rarr; SLMS</title>
            ...
            <div id="page-title-bar" class="page-title-bar page-title-bar-01">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Colleges</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
             ...
             <div class="container">
                ...
                <div class=" col-lg-2 col-md-4 col-sm-6 col-xs-12" >
                    ...
                    <div>
                    <input class="form-control border border-success me-2" type="text" name="search"  style="display:block; text-align:right !important" id="search" onchange="search()" placeholder="Search" aria-label="Search">
                    </div>
                </div>
                                                                                        ...
                                                                                        <div class="post-wrapper maxcoach-box">
                                                                                            <div class="post-thumbnail-wrapper">
                                                                                                <div class="post-feature post-thumbnail maxcoach-image school-image">
                                                                                                    <a href="#">
                                                                                                        <img src="<?= $ans['c_image'] ?>" alt="home-personal-finance-blog-03" />
                                                                                                    </a>
                                                                                            ...
                                                                                            <div class="post-caption">
                                                                                                ...
                                                                                                <h3 class="post-title">
                                                                                                    <a href="<?= $ans["website"] ?>" target="_blank" title="<?= $ans['c_name'] ?>"><?= $ans['c_name'] ?></a>
                                                                                                </h3>
                                                                                                <div class="post-meta">
                                                                                                    <div class="inner">
                                                                                                        <div class="post-date">
                                                                                                ...
                                                                                                <?php if (isset($_SESSION['user'])) { ?>
                                                                                                    <?php if ($_SESSION["user_type"] == 'Government Panel' || $_SESSION["user_type"] == 'College Panel') { ?>
                                                                                                        <?php if ($_SESSION['user'] == $ans['c_name']) { ?>
                                                                                                                    ...
                                                                                                                    <div class="post-share style-01">
                                                                                                                        ...
                                                                                                                        <div class="share-media">
                                                                                                                            ...
                                                                                                                            <div class="share-list">
                                                                                                                                <form action="./add_college_student.php" method="post">
                                                                                                                                    <a class="hint--bounce hint--top hint--primary facebook" target="_self" aria-label="Add Student" href="../includes/add_college_student.php">
                                                                                                                                        <button type="submit" value="<?= $ans["id"] ?>" name="add_stud" style="background-color:orange; border-color:orange"><i class="fab fa fa-plus" id="addstudent"></i></button>
                                                                                                                                    </a>
                                                                                                                                </form>
                                                                                                                                ...
                                                                                                                                <form action="./all_student.php" method="post">
                                                                                                                                    <a class="hint--bounce hint--top hint--primary twitter" target="_self" aria-label="View Student" href="../includes/all_student.php">
                                                                                                                                        <button type="submit" value="<?= $ans["c_name"] ?>" name="view" style="background-color:grey; border-color:grey"><i class="fab fa fa-eye"></i></button>
                                                                                                                                        <!-- <button id="allstudent">View Student</button> -->
                                                                                                                                    </a>
                                                                                                                                </form>
                                                                                                                                <form action="./update_college.php" method="post">
                                                                                                                                    <a class="hint--bounce hint--top hint--primary linkedin" target="_self" aria-label="Update College" href="../includes/update_college.php">
                                                                                                                                        <button type="submit" value="<?= $ans["id"] ?>" name="update_id"><i class="fab fa fa-arrow-up"></i></button>
                                                                                                                                    </a>
                                                                                                                                </form>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                        ...
                                                                                        <?php
                                                                                            for ($i = 1; $i <= $pageCount; $i++) {
                                                                                                if (!isset($_GET["page"]))
                                                                                                    $_GET["page"] = 1;
                                                                                            ?>
                                                                                                <li class="page-item <?= $_GET["page"] == $i ? "active" : "" ?>"><a class="page-link" href="all_colleges.php?page=<?= $i ?>&range=<?= $range ?>"><?= $i ?></a></li>
                                                                                            <?php
                                                                                            }
                                                                                            ?>
                                                                                        </ul>
 ...
 -->
    ...
    <script>
        function changerange() {
            ...
            window.location.href = "all_colleges.php?range=" + range;
        }
        function changeSort() {
        ...
        function changedis() {
            ...
            window.location.href = "all_colleges.php?district=" + district;    
        }
        function search() {
            var search = document.getElementById('search').value;
            window.location.href = "all_colleges.php?search=" + search;
        }
    </script>
