...
<head>
    ...
    <title>Add User &rarr; SLMS</title>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Add Employee Request Form</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="learnpress">
                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-register-wrap col-md-6 col-md-push-3">
                                        ...
                                        <div class="learn-press-form-register learn-press-form">
                                            ...
                                            <h3 style="text-align: center;">Add Employee Request Form</h3>

                                            <form name="learn-press-register" method="post" action="<?= urlOf('assets/codes/request_user_code.php') ?>" enctype="multipart/form-data">
                                                <ul class="form-fields">
                                                    <li class="form-field">
                                                        <label for="reg_username">Employee No.&nbsp;<span>*</span></label>
                                                        <input id="number" name="emp_no" type="number" placeholder="Enter Employee Number : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Employee Name&nbsp;<span class="required">*</span></label>
                                                        <input id="schoolname" name="emp_name" type="text" placeholder="Enter Employee name : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_username">Upload Adhar-Card&nbsp;<span>*</span></label>
                                                        <input id="doc1" name="emp_adhar" type="file" placeholder="Upload Student Image : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Upload Pan-Card&nbsp;<span>*</span></label>
                                                        <input id="doc2" name="emp_pan" type="file" placeholder="Upload Student Image : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Upload Election-Card&nbsp;<span>*</span></label>
                                                        <input id="doc3" name="emp_election" type="file" placeholder="Upload Student Image : " autocomplete="number" value="" required>
                                                    </li>
                                                </ul>
                                                <p>
                                                    ...
                                                    <button type="submit" id="addschool">Pull Request</button>
                                                </p>
                                            </form>
