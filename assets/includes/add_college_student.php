...
$result = $query->fetch();
$select_all = "SELECT * FROM colleges";
$query_all = $connection->query($select_all);
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Add Student</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="learnpress">
                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-register-wrap col-md-6 col-md-push-3">
                                        ...
                                        <div class="learn-press-form-register learn-press-form">
                                            ...
                                            <form name="learn-press-register" method="post" action="<?= urlOf('assets/codes/request_college_student_code.php') ?>" enctype="multipart/form-data">
                                                <ul class="form-fields">

                                                <li class="form-field">
                                                     '
                                                        <!-- <label for="reg_username">School Name&nbsp;<span>*</span></label> -->
                                                        <input list="class" name="c_name" type="hidden" value="<?= $result['c_name'] ?>">
                                                        <!-- <datalist id="class"> -->
                                                    </li>
                                                    
                                                    <li class="form-field">
                                                        <label for="reg_name">Student Name&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="stud_name" type="text" placeholder="Surname Name Fathers-name : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Fathers Name&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="f_name" type="text" placeholder="Surname Name Fathers-name : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Mothers Name&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="m_name" type="text" placeholder="Surname Name Husbands-name : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Fathers Occupation&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="f_occupation" type="text" placeholder="Enter Fathers Occupation : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Mothers Occupation&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="m_occupation" type="text" placeholder="Enter Mothers Occupation : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_name">Email&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="email" type="email" placeholder="Enter your Email : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_email">Date of Birth&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="dob" type="date" placeholder="Enter University Email : " autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_username">Number&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="number" type="number" placeholder="Enter Number : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Alternate Number&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="a_number" type="number" placeholder="Enter Alternate Number : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Aadharcard Number&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="adhar" type="number" placeholder="Enter Adharcard Number : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your Semester&nbsp;<span>*</span></label>
                                                        <input list="sem" name="ds" required>
                                                        <datalist id="sem">
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_email">Marks of Previous Year&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="marks" type="number" autocomplete="email" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        <label for="reg_username">Remarks&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="remarks" type="text" placeholder="Remarks : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your State&nbsp;<span>*</span></label>
                                                        <input type="text" name="state" value="<?= $result['state'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your District / Village&nbsp;<span>*</span></label>
                                                        <input type="text" name="district" value="<?= $result['district'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your University&nbsp;<span>*</span></label>
                                                        <input type="text" name="board" value="<?= $result['university'] ?>" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Upload Student Image&nbsp;<span>*</span></label>
                                                        <label for="reg_username">Suggested [W : 413px , H : 620px] &nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="image" type="file" placeholder="Upload Student Image : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Student Birth Certificate &nbsp;<span>*</span></label>
                                                        <!-- <label for="reg_username">Suggested [W : 413px , H : 620px] &nbsp;<span>*</span></label> -->
                                                        <input id="reg_username" name="birth_certificate" type="file" placeholder="Upload Student Birth Certificate : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Upload Father Adhar Card &nbsp;<span>*</span></label>
                                                        <!-- <label for="reg_username">Suggested [W : 413px , H : 620px] &nbsp;<span>*</span></label> -->
                                                        <input id="reg_username" name="f_adhar" type="file" placeholder="Upload Father Adhar Card  : " autocomplete="number" value="" required>
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Upload Mother Adhar Card  &nbsp;<span>*</span></label>
                                                        <!-- <label for="reg_username">Suggested [W : 413px , H : 620px] &nbsp;<span>*</span></label> -->
                                                        <input id="reg_username" name="m_adhar" type="file" placeholder="Upload Mother Adhar Card  : " autocomplete="number" value="" required>
                                                    </li>
                                                </ul>
                                                <p>
