                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>All Students</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="page-main-content" class="page-main-content">
                            ...
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    if(isset($_POST["view"])){
                                        $name = $_POST["view"];   
                                        $select = "SELECT * FROM students WHERE c_name = '$name'";
                                        ...
                                        $select = "SELECT * FROM students WHERE sc_name = '$name'";
                                        $query = $connection->query($select);
                                        $result = $query->fetchAll(PDO::FETCH_ASSOC);
                                    }
                                    echo $_SESSION["user"];
                                    ...
                                    foreach ($result as $data) { ?>
                                        ...
                                        <form action="./view_student.php" method="post">
                                            ...
                                            <td><button style="background: transparent;color: gray;border: none;" type = "submit" name="student" value="<?= $data['id'] ?>"><?= $data['stud_name'] ?></button></td>
                                            </form>
                                            <td><?= $data['slms_no'] ?></td>
                                            <td><?= $data['email'] ?></td>
                                            <td><?= $data['dob'] ?></td>
                                            ...
                                            <form action="./update_student.php" method="post">
                                                <td><button type='submit' value="<?= $data['id'] ?>" name='update_btn' id='edit-btn'>Edit</button>
                                            </form>
                                            <form action="../codes/delete_student.php" method="post">
                                                <td><button type='submit' value="<?= $data['id'] ?>" name='delete_student' id='delete-btn'>Delete</button></td>
                                            </form>
                                    ...
                                    <?php $orgDate = $ans['dob'];
                                        ...
                                        <tr>
                                            <td><?= $ans['slms_no'] ?></td>
                                            <td>
                                                <a href="../includes/view_student.php?id=<?= $ans['id'] ?>" target="_self">
                                                    <?= $ans['stud_name'] ?>
                                                </a>
                                            </td>
                                            ...
                                            <td><?= $ans['class'] ?></td>
                                            <form action="./update_student.php" method="post">
                                            <td><button type="submit" value="<?= $ans["id"] ?>" name="update_btn" id="edit-btn">Edit</button></td>
                                            </form>
                                            <form action="../codes/delete_student.php" method="post">
                                            <td><button id="delete-btn" type="submit" value="<?= $ans['id'] ?>" name='delete_student'>Delete</button></a></td>
                                            </form>
                                        </tr>
                                        <?php } ?> -->
                                </tbody>
